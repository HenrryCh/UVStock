          ...
          <div class="card">
            ...
            @foreach( $rol2['permisos'] as $key2 => $permisito)
              ...
              <div class="row">
                ...
                <div class="col-lg-1">
                  <input type="checkbox" name="listar[{{$key2}}]" value="list {{$permiso["tabla"]}}" {{($permiso["listar"]==1) ? 'checked' : ''}} disabled>
                </div>
                <div class="col-lg-1">
                ...
                <div class="col-lg-1">
                  <input type="checkbox" name="eliminar[{{$key2}}]" value="delete {{$permiso["tabla"]}}" {{($permiso["eliminar"]==1) ? 'checked' : ''}} disabled>
                </div>
                <div class="col-lg-1">
