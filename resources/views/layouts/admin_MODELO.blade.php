...
<div class="wrapper">
        ...
        <ul class="navbar-nav ml-auto">
            <li class="nav-item dropdown user-menu">
                <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
                    <img src="{{ asset('img/campana.png') }}" style="height:40px;" class="brand-image-xl.single">
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2022 <a href="https://fabrica-software.com" target="_blank">https://fabrica-software.com</a>.</strong> All rights
        reserved.
    </footer>
</div>
