...
<div class="row">
	<div class="col-lg-12 col-md-8 col-sm-8 col-xs-12">
		<h3>Productos<a href="productos/create"></a></h3>
	</div>
		                ...
		                @foreach ($productos as $producto)
							<tr>
								...
								<td class="d-flex justify-content-center">
									@can('show productos')
			                        <a href="" data-target="#modal-ver-{{$producto->id}}" data-toggle="modal" title="Ver datos de este registro"><button class="btn btn-success btn-sm shadow"><i class='fa fa-eye'></i></button></a>
			                        @endcan
									@can('edit productos')
									<a href="" data-target="#modal-edit-{{$producto->id}}" data-toggle="modal" title="Editar datos de este registro"><button class="btn btn-info btn-sm shadow"><i class='fa fa-edit'></i></button></a>
									@endcan
			                        ...
			                        <form action="/productos/{{ $producto->id}}/estado" method="POST">
									    ...
									    <button class="btn btn-{{$producto->estado ? 'danger' : 'success'}} btn-sm shadow" type="submit">{{ $producto->estado ? 'Desactivar' : 'Activar' }}</button>
									</form>
									@endcan
								</td>
							</tr>
