{!! Form::open(array('url'=>'productos_filtro_report','method'=>'GET','autocomplete'=>'off','role'=>'search', 'id' => 'formFiltro2')) !!}
<div class="row">
    <div class="col-lg-4">
        <div class="form-group form-inline">
            <label style="display: inline-block;">Categorias:</label>
...
<script>
    $(document).ready(function() {
        $('#formFiltro2').on('submit', function(e) {
            e.preventDefault();
